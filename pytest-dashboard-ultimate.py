#!/usr/bin/env python3
"""
Ultimate Pytest Dashboard - Opens NEW terminal, TRUE sticky bottom bar with spinner
Complete jest-dashboard experience with blinking indicators and clean exit
"""
...
class UltimatePytestDashboard:
    """Ultimate dashboard with new terminal, sticky bar, spinner, and clean exit"""
    ...
    def __init__(self):
        ...
        self.running = True
        self.output_lines = []
        self.max_display_lines = 12  # Lines to show above status bar
    ...
    def run_tests(self, pytest_args: list = None):
        """Run pytest with ultimate sticky dashboard"""
        ...
        print("🚀 Starting ULTIMATE Pytest Dashboard...")
        print(f"📋 Command: {' '.join(cmd)}")
        print("🔄 Opening new terminal and focusing...")
        time.sleep(1)
        ...
        try:
            ...
            for line in iter(process.stdout.readline, ''):
                ...
                # Update sticky dashboard every line for smooth spinner
                line_count += 1
                if line_count % 1 == 0:  # Update every line for smooth animation
...
def main():
    ...
    # Run dashboard
    dashboard = UltimatePytestDashboard()
