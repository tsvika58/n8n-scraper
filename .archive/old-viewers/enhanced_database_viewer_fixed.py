...
<body>
    ...
    <script>
        ...
        let allWorkflows = {json.dumps([dict(w) for w in workflows], default=str)};
        ...
        // Search on Enter key or after typing
        ...
        // Filter change handlers - submit form for server-side filtering
        ...
        function performSearch(searchValue) {{
            // For search, just submit the form to reload with filters
            document.getElementById('searchForm').submit();
        }}
