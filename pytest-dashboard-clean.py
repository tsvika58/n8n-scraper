#!/usr/bin/env python3
"""
Pytest Dashboard - CLEAN WORKING VERSION
Shows progress without excessive updates
"""
...
class PytestDashboard:
    ...
    def run_tests(self, args):
        ...
        print("🚀 Starting Clean Pytest Dashboard...")
        ...
        try:
            ...
            while True:
                ...
                # Show progress every 3 tests, but only if tests are still running
                if self.total > 0 and self.total % 3 == 0 and not self.tests_completed:
                    self.print_progress()
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python pytest-dashboard-clean.py [pytest-args...]")
        print("Example: python pytest-dashboard-clean.py -v tests/test_logging.py")
        sys.exit(1)
